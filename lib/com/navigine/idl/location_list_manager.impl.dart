...
Map<int, LocationInfo> navigine_sdk_flutter_Map_int_LocationInfo_FromFfi(Pointer<Void> handle) {
    ...
    while (_navigine_sdk_flutter_Map_int_LocationInfo_IteratorIsValid(handle, _iteratorHandle) != 0)  {
        ...
        navigine_sdk_flutter_LocationInfo_ReleaseFfiHandle(_keyHandle);navigine_sdk_flutter_LocationInfo_ReleaseFfiHandle(_valueHandle);_navigine_sdk_flutter_Map_int_LocationInfo_IteratorIncrement(_iteratorHandle);
    }
