...
class Sublocation$Impl extends __lib.NativeBase implements Sublocation {
    ...
    int get location {
        ...
        try  {
            return navigine_sdk_flutter_int_FromFfi(_locationHandle);
        }
        finally  {
    ...
    double get width {
        ...
        try  {
            return navigine_sdk_flutter_double_FromFfi(_widthHandle);
        }
        finally  {
    ...
    double get height {
        ...
        try  {
            return navigine_sdk_flutter_double_FromFfi(_heightHandle);
        }
        finally  {
    ...
    double? get altitude {
        ...
        try  {
            return navigine_sdk_flutter_double_FromFfiNullable(_altitudeHandle);
        }
        finally  {
    ...
    double get azimuth {
        ...
        try  {
            return navigine_sdk_flutter_double_FromFfi(_azimuthHandle);
        }
        finally  {
    ...
    GlobalPoint get originPoint {
        ...
        try  {
            return navigine_sdk_flutter_GlobalPoint_FromFfi(_originPointHandle);
        }
        finally  {
    ...
    String get levelId {
        ...
        try  {
            return navigine_sdk_flutter_String_FromFfi(_levelIdHandle);
        }
        finally  {
    ...
    String get externalId {
        ...
        try  {
            return navigine_sdk_flutter_String_FromFfi(_externalIdHandle);
        }
        finally  {
    ...
    List<Beacon> get beacons {
        ...
        try  {
            return navigine_sdk_flutter_List_Beacon_FromFfi(_beaconsHandle);
        }
        finally  {
    ...
    List<Eddystone> get eddystones {
        ...
        try  {
            return navigine_sdk_flutter_List_Eddystone_FromFfi(_eddystonesHandle);
        }
        finally  {
    ...
    List<Wifi> get wifis {
        ...
        try  {
            return navigine_sdk_flutter_List_Wifi_FromFfi(_wifisHandle);
        }
        finally  {
    ...
    List<ReferencePoint> get referencePoints {
        ...
        try  {
            return navigine_sdk_flutter_List_ReferencePoint_FromFfi(_referencePointsHandle);
        }
        finally  {
    ...
    List<Venue> get venues {
        ...
        try  {
            return navigine_sdk_flutter_List_Venue_FromFfi(_venuesHandle);
        }
        finally  {
    ...
    List<Zone> get zones {
        ...
        try  {
            return navigine_sdk_flutter_List_Zone_FromFfi(_zonesHandle);
        }
        finally  {
