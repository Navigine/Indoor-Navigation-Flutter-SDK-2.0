...
final _navigine_sdk_flutter_RouteManager_RegisterFinalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>, Int32, Handle),
    void Function(Pointer<Void>, int, Object)
  >('navigine_sdk_flutter_RouteManager_register_finalizer'));

final _navigine_sdk_flutter_RouteManager_GetTypeId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('navigine_sdk_flutter_RouteManager_get_type_id'));
...
class RouteManager$Impl extends __lib.NativeBase implements RouteManager {
...
RouteManager navigine_sdk_flutter_RouteManager_FromFfi(Pointer<Void> handle) {
    ...
    if (instance != null && instance is RouteManager) return instance;
    final _typeIdHandle = _navigine_sdk_flutter_RouteManager_GetTypeId(handle);
    ...
    final result = factoryConstructor != null
      ...
      : RouteManager$Impl(_copiedHandle);
    __lib.cacheInstance(_copiedHandle, result);
    _navigine_sdk_flutter_RouteManager_RegisterFinalizer(_copiedHandle, __lib.LibraryContext.isolateId, result);
    return result;
}
