...
Map<SensorType, SensorMeasurement> navigine_sdk_flutter_Map_SensorType_SensorMeasurement_FromFfi(Pointer<Void> handle) {
    ...
    while (_navigine_sdk_flutter_Map_SensorType_SensorMeasurement_IteratorIsValid(handle, _iteratorHandle) != 0)  {
        ...
        navigine_sdk_flutter_SensorMeasurement_ReleaseFfiHandle(_keyHandle);navigine_sdk_flutter_SensorMeasurement_ReleaseFfiHandle(_valueHandle);_navigine_sdk_flutter_Map_SensorType_SensorMeasurement_IteratorIncrement(_iteratorHandle);
    }
