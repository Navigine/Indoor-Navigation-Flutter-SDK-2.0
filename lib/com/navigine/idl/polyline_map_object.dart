...
abstract class PolylineMapObject implements MapObject {
...
final _navigine_sdk_flutter_PolylineMapObject_RegisterFinalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>, Int32, Handle),
    void Function(Pointer<Void>, int, Object)
  >('navigine_sdk_flutter_PolylineMapObject_register_finalizer'));

final _navigine_sdk_flutter_PolylineMapObject_GetTypeId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('navigine_sdk_flutter_PolylineMapObject_get_type_id'));
...
class PolylineMapObject$Impl extends __lib.NativeBase implements PolylineMapObject {
...
PolylineMapObject navigine_sdk_flutter_PolylineMapObject_FromFfi(Pointer<Void> handle) {
    ...
    if (instance != null && instance is PolylineMapObject) return instance;
    final _typeIdHandle = _navigine_sdk_flutter_PolylineMapObject_GetTypeId(handle);
    ...
    final result = factoryConstructor != null
      ...
      : PolylineMapObject$Impl(_copiedHandle);
    __lib.cacheInstance(_copiedHandle, result);
    _navigine_sdk_flutter_PolylineMapObject_RegisterFinalizer(_copiedHandle, __lib.LibraryContext.isolateId, result);
    return result;
}
