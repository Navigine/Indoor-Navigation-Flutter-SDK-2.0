...
final _navigine_sdk_flutter_Location_RegisterFinalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>, Int32, Handle),
    void Function(Pointer<Void>, int, Object)
  >('navigine_sdk_flutter_Location_register_finalizer'));

final _navigine_sdk_flutter_Location_GetTypeId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('navigine_sdk_flutter_Location_get_type_id'));
...
final _navigine_sdk_flutter_Location_CreateProxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint64, Int32, Int64, Handle, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer),
    Pointer<Void> Function(int, int, int, Object, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer)
  >('navigine_sdk_flutter_Location_create_proxy'));


class Location$Impl extends __lib.NativeBase implements Location {
...
Location navigine_sdk_flutter_Location_FromFfi(Pointer<Void> handle) {
    ...
    if (instance != null && instance is Location) return instance;
    final _typeIdHandle = _navigine_sdk_flutter_Location_GetTypeId(handle);
    ...
    final result = factoryConstructor != null
      ...
      : Location$Impl(_copiedHandle);
    __lib.cacheInstance(_copiedHandle, result);
    _navigine_sdk_flutter_Location_RegisterFinalizer(_copiedHandle, __lib.LibraryContext.isolateId, result);
    return result;
}
