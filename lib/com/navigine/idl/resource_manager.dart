...
final _navigine_sdk_flutter_ResourceManager_RegisterFinalizer = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>, Int32, Handle),
    void Function(Pointer<Void>, int, Object)
  >('navigine_sdk_flutter_ResourceManager_register_finalizer'));

final _navigine_sdk_flutter_ResourceManager_GetTypeId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('navigine_sdk_flutter_ResourceManager_get_type_id'));
...
class ResourceManager$Impl extends __lib.NativeBase implements ResourceManager {
...
ResourceManager navigine_sdk_flutter_ResourceManager_FromFfi(Pointer<Void> handle) {
    ...
    if (instance != null && instance is ResourceManager) return instance;
    final _typeIdHandle = _navigine_sdk_flutter_ResourceManager_GetTypeId(handle);
    ...
    final result = factoryConstructor != null
      ...
      : ResourceManager$Impl(_copiedHandle);
    __lib.cacheInstance(_copiedHandle, result);
    _navigine_sdk_flutter_ResourceManager_RegisterFinalizer(_copiedHandle, __lib.LibraryContext.isolateId, result);
    return result;
}
