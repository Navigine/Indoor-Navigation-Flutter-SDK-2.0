...
Map<String, String> navigine_sdk_flutter_Map_String_String_FromFfi(Pointer<Void> handle) {
    ...
    while (_navigine_sdk_flutter_Map_String_String_IteratorIsValid(handle, _iteratorHandle) != 0)  {
        ...
        navigine_sdk_flutter_String_ReleaseFfiHandle(_keyHandle);navigine_sdk_flutter_String_ReleaseFfiHandle(_valueHandle);_navigine_sdk_flutter_Map_String_String_IteratorIncrement(_iteratorHandle);
    }
